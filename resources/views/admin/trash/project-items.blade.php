    ...
    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        <td class="px-2 py-1 text-end">
            <div class="btn-group pe-3">
                @if (permission_check('Project Restore'))
                    <form method="POST" id="re_form_{{ $project->id }}"
                        action="{{ route('admin.trash.update', $project->id) }}">@csrf @method('PUT')</form>
                    <button form="re_form_{{ $project->id }}" type="submit" title="Restore Project"
                    ...
                    <input form="re_form_{{ $project->id }}" type="hidden" value="restore" name="project">
                @endif
                ...
                @if (permission_check('Project Delete'))
                    ...
                    <input form="form_{{ $project->id }}" type="hidden" value="trash" name="from">
                @endif
            </div>
        </td>
    </tr>
