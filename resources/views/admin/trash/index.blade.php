...
@section('content')
    ...
    <div class="container card overflow-x-auto shadow-md sm:rounded-lg mt-3">
        <div class="relative p-4" x-data="propertyTabs()">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <button type="button" @click="fetchTabData('properties')"
                        :class="selectedTab === 'properties' ? 'text-white bg-dark fw-bold' :
                ...
                <li class="nav-item">
                    <button type="button" @click="fetchTabData('projects')"
                        :class="selectedTab === 'projects' ? 'text-white bg-dark fw-bold' :
                            'bg-gray-200 text-gray-700'"
                        class="nav-link">
                        Projects
                    </button>
            ...
            <div x-show="selectedTab === 'properties'">
                <!-- Properties listing -->
                <div>
                        ...
                        <div class="relative">
                            ...
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <tbody id="property-rows">
                                    @include('admin.trash.property-items', compact('properties'))
                                </tbody>
                            </table>
                        </div>
            ...
            <div x-show="selectedTab === 'projects'">
                <!-- Projects listing -->
                <div>
                    <div class="overflow-x-auto  sm:rounded-lg mt-3">
                        <div class="relative">
                            ...
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <tbody id="property-rows">
                                    @include('admin.trash.project-items', compact('projects'))
                                </tbody>
                            </table>
                        </div>
...
@push('footer')
    <script>
        function propertyTabs() {
            return {
                selectedTab: 'properties', // Default tab
