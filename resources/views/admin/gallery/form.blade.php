    ...
    <div
        ...
        <nav>
            <ol class="flex flex-wrap items-center gap-2">
                ...
                <li>
                    <a class="flex items-center gap-3 font-medium" href="{{ route('admin.gallery.index') }}">
                      ...
                      <span class="hover:text-primary">Gallery</span>
                    </a>
                  </li>
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                <h2 class="text-title-sm2 font-bold text-black dark:text-black">
                    {{ isset($gallery) ? 'Edit gallery' : 'Create a gallery' }}
                </h2>
            </div>
            ...
            <form enctype="multipart/form-data"
                ...
                <div class="p-6.5 ">
                    ...
                    <div class="mb-5 w-full">
                        ...
                        <div x-data="imageHandler('{{ isset($gallery) && $gallery->image ? asset('images/' . $gallery->image) : '' }}')" class="mt-2 flex gap-15">
                            ...
                            <label for="desktop_image"
                                ...
                                <span class="small"> Max size 100kb</span>
                                <small></small>
                                <input type="file" id="desktop_image" name="image" class="hidden"
                    ...
                    <div class="mb-5 w-1/4">
                        <label class="block mb-2 text-sm font-medium text-black dark:text-dark">Display Order</label>
                        <select class="form-control mt-2" name="display_order" required>
                            @for ($i = 1; $i < 10; $i++)
                                <option {{ isset($gallery) && $gallery->display_order == $i ? 'selected' : '' }}
                                    value="{{ $i }}">{{ $i }}</option>
                            @endfor
                        </select>
                    </div>
                        ...
                        <div class="form-group mb-3 col-md-4">
                            <label class="form-check form-switch">
                                <input class="form-check-input" name="status" type="checkbox" value="1" id="status"
                                    {{ old('status', isset($gallery) && $gallery->status ? 'checked' : '') }}>
