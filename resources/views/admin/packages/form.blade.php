    ...
    <div
        ...
        <nav>
            <ol class="flex flex-wrap items-center gap-2">
                ...
                <li>
                    <a class="flex items-center gap-3 font-medium" href="{{ route('admin.packages.index') }}">
                      ...
                      <span class="hover:text-primary">Packages</span>
                    </a>
                  </li>
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                <h2 class="text-title-sm2 font-bold text-black dark:text-black">
                    {{ isset($package) ? 'Edit service' : 'Create a service' }}
                </h2>
            </div>
            ...
            <form enctype="multipart/form-data"
                ...
                <div class="p-6.5 ">
                    ...
                    <div class="mb-5 w-full">
                        ...
                        <div x-data="imageHandler('{{ isset($package) && $package->image ? asset('images/' . $package->image) : '' }}')" class="flex gap-15 mt-2">
                            ...
                            <label for="image"
                                ...
                                <span class="small">Recommended resolution 320*500 with Max size 100kb</span>
                    ...
                    <div class="mb-5 w-full">
                        ...
                        <input type="text" name="description" class="form-control tinyeditor" value="{{ old('description', $package->description ?? '') }}" />
                    </div>
                    <!-- Display Order -->
                    <div class="mb-5 w-1/4">
                        ...
                        <select class="form-control mt-2" name="display_order" required>
                            @for ($i = 1; $i < 20; $i++)
                                <option {{ isset($package) && $package->display_order == $i ? 'selected' : '' }}
                                    value="{{ $i }}">{{ $i }}</option>
                            @endfor
                        </select>
                    </div>
                        ...
                        <div class="form-group mb-3 col-md-4">
                            <label class="form-check form-switch">
                                <input class="form-check-input" name="status" type="checkbox" value="1" id="status"
                                    {{ old('status', isset($package) && $package->status ? 'checked' : '') }}>
